...
(function () {
  ...
  const showInCompleteResults = function (result, task) {
    setTimeout(() => {
      console.log("taskInComplete" + result);
      task.classList.remove('loading');
      if (result[1] === 201) {
      ...
      const modalContent = `
        <div class="people-teaser__more modal-inner">
          <div class="people-teaser__more-container container">
            ...
            <div class="people-teaser__more-image">${hasImage(
              peopleData.image,
              peopleData.imageAlt,
              peopleData.url,
            )}</div>
            <div class="people-teaser__more-content">
              <div>
  ...
  accountMenu.forEach((item) => {
    ...
    const itemIcon =
      itemHref === '/search'
        ...
        : itemHref === '/user/login' || itemHref === '/dashboard'
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./components/03-organisms/search/search-filter.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./components/03-organisms/search/search-filter.js":
/*!*********************************************************!*\
  !*** ./components/03-organisms/search/search-filter.js ***!
  \*********************************************************/
