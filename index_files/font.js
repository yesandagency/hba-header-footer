/*fontURL = 'https://www.googleapis.com/webfonts/v1/webfonts?key=AIzaSyCn5ICd2f_j9glEC-iy33zaga6XO-aMPn0'*/
(function ($) {
    var GWFFonts = [];
    var loadedFonts = {};
    var fontFetch = (function () {
        var fontURL = '/admin31/common/jquery-widgets/font/font_data.html',
            callbacks = [],
            fetching = false;
        var fetch = function () {
